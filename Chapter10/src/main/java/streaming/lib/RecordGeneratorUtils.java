  ...
  private RecordGeneratorUtils() throws RecordGeneratorException {
    try {
      femaleFirstNames = Files.readAllLines(new File(
          "Chapter10/src/main/resources/data/female_first_names.txt").toPath(),
    ...
    try {
      maleFirstNames = Files.readAllLines(new File(
          "Chapter10/src/main/resources/data/male_first_names.txt").toPath(),
          Charset.defaultCharset());
    } catch (IOException e) {
    ...
    try {
      lastNames = Files.readAllLines(new File(
          "Chapter10/src/main/resources/data/last_names.txt").toPath(),
          Charset.defaultCharset());
    } catch (IOException e) {
